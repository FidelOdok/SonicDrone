    ...
    public partial class Scherm_1 : Form
    {
        ...
        private void OpenClose_Click(object sender, EventArgs e)
        {
            if (OpenClose.Text == "Open")
            {
                ...
                {
                    dataprogress = new Progress<bool>(val =>
                      {
                          if (val) 
                            Timer2_Tick(null, null);
                      });
                    _port = PortNumber.Text;
        ...
        private void Timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (first_receive == 1)
            {
                if (milliseconds - last_receive > 2000 && label24.Visible == false)
                    label24.Visible = true;
                if (milliseconds - last_receive < 1000 && label24.Visible == true) 
                    label24.Visible = false;
